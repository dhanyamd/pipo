...
import SearchBar from './upper-info-bar-search'
...
<Button className='bg-primary-80 rounded-lg hover:bg-background-80 text-primary font-semibolf cursor-not-allowed'>
<Upload />
Import
</Button>
