...
>(({ className, ...props }, ref) => (
  ...
  >
    <Moon 
    className={cn('h-4 w-4 absolute z-[1000] top-[10px] left-[10px] stroke-gray-600 fill-white transition-opacity duration-300 ease-in-out',
    ...
    />
    <Sun 
    className={cn('h-4 w-4 absolute z-[1000] top-[10px] right-[19px] stroke-gray-600 fill-black transition-opacity duration-300 ease-in-out',
